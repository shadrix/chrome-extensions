...
Once you have loaded your extension into Chrome, you can use it by navigating to any website and pressing the `Escape` key. This will toggle the extension popup on and off.
